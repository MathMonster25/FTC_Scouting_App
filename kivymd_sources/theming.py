...
from kivymd_sources.color_definitions import colors, hue, palette
from kivymd_sources.font_definitions import theme_font_styles
from kivymd_sources.material_resources import DEVICE_IOS, DEVICE_TYPE
